<section class="popup-price fancy__class" id="popup-price" data-package="">
	...
	<?php /* ?>	<div class="popup-price__text condensed" js-text>
			...
			<div class="popup-price__text">
				<ul>
					<li class="popup-price__text-item">Аккредитация на&nbsp;форуме</li>
					<li class="popup-price__text-item">Курс &laquo;Прибыльный Instagram с&nbsp;нуля&raquo; (тариф &laquo;Новичок&raquo;)</li>
				</ul>
			</div>
