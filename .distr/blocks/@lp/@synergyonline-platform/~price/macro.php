...
<?php if ($version != 'thanks-external') { ?>
	<?php if (( $version == 'lp-version-besson' && $lang == 'en') || $version == 'lp-version-besson' ) { ?>
		{{ header_besson() }}
	<?php } else if ($version == 'lp-version-taleb') { ?>
		{{ header_taleb() }}
	<?php } else if (( $version == 'lp-version-brown' && $lang == 'en') || $version == 'lp-version-brown' ) { ?>
		{{ header_brown() }}
	<?php } else { ?>
...
{% macro header_besson() %}
<div class="price-header-besson" id="price-header">
	<div class="container">
		<div class="price-header-besson__title condensed"><?= _('besson__title') ?></div>
		<div class="price-header-besson__note"><?= _('besson__note') ?></div>
	</div><!-- container -->
</div><!-- price-header-besson -->
{% endmacro %}

{% macro header_taleb() %}
<div class="price-header-taleb" id="price-header">
	<div class="container">
		<div class="price-header-taleb__title condensed"><?= _('taleb__title') ?></div>
		<div class="price-header-taleb__note"><?= _('taleb__note') ?></div>
	</div><!-- container -->
</div><!-- price-header-taleb -->
{% endmacro %}

{% macro header_brown() %}
<div class="price-header-brown" id="price-header">
	<div class="container">
		<div class="price-header-brown__title condensed"><?= _('brown__title') ?></div>
		<div class="price-header-brown__note"><?= _('brown__note') ?></div>
	</div><!-- container -->
</div><!-- price-header-brown -->
{% endmacro %}
...
<div class="price-payment__title condensed">
	...
	<div class="price-payment__options">
		...
		<?php */ ?>
		<?php if ($version == 'lp-version-taleb') { ?>
			<?php if ($lang == 'ru') { ?>
				<div class="price-payment__options-image"><?= picture('img/price/payment/stripe.png', 'lazy') ?></div>
			<?php } else { ?>
				<div class="price-payment__options-image"><?= picture('img/price/payment/ae.png', 'lazy') ?></div>
				<div class="price-payment__options-image"><?= picture('img/price/payment/discover.png', 'lazy') ?></div>
				<div class="price-payment__options-image"><?= picture('img/price/payment/jcb.png', 'lazy') ?></div>
			<?php } ?>
		<?php } else { ?>
...
<div class="payments__wrapper payments__wrapper_1" id="payment-wrapper">
	...
	<?php if ( $lang == 'en' && $lang == 'tr' && $lang == 'es' && $lang == 'pt' ) { ?>
...
{% macro card(item) %}
<div href="#popup-price" data-fancybox class="price-card" id="price-{{ item.id }}" js-payment data-productId="{{ item.product_id | safe }}" data-is-recurrent="{{ item.is_recurrent | safe }}" data-quote_id="{{ item.quote_id | safe }}" data-partner="{{ item.partner | safe }}" data-package="{{ item.id }}">
	...
	<div class="price-card__seemore">
		<div class="price-card__seemore-text-1"><?= _('price-card__seemore') ?></div>
		<div class="price-card__seemore-text-2">Свернуть</div>
	</div>
	<div class="d-none">
		{% if item.popup_title %}
