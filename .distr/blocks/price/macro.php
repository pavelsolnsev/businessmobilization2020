{% from './data.php' import data_packages as packages, data_academic_packages as academic_packages, data_language_packages as language_packages, data_packages_eng as packages_eng, data_brain2021_packages as brain2021_packages %}
...
<div class="payments__wrapper payments__wrapper_1" id="payment-wrapper">
	...
	<?php /* } elseif ( $external_url == 'brain2021') { echo 'myBlock' ?>
		...
		{% for item in brain2021_packages %}
		{{ card(item) }}
		{% endfor %} <php */ ?>
