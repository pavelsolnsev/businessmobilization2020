...
<section class="about" id="about">
	...
	<div class="container">
		<div class="about__title xcondensed color-blue"><?= _('about__kotler_title') ?></div>
		<div class="about__text"><?= _('about__kotler_text') ?></div>
	</div><!-- container -->
...
?>
<?php } ?>
<section class="whois" id="whois">

	<div class="container-fluid">

		<div class="row whois__content">
			<div class="whois__img whois__img_top"><?= picture('img/@lp/@version-kotler/whois/kotler.png', 'lazy') ?></div>
			<div class="whois__text">
				<h2 class="whois__title xcondensed color-blue"><?= _('whois__kotler_title') ?></h2>
				<p><?= _('whois__kotler_text_1') ?></p>
				<p><?= _('whois__kotler_text_2') ?></p>
			</div>
		</div>
		...
		<div class="blockquote">
			<div class="container">
				<div class="blockquote__text">
					<p><?= _('whois__kotler_blockquote_text_1') ?></p>
					<p><?= _('whois__kotler_blockquote_text_2') ?></p>
				</div>
			</div>
		</div>
		<div class="blockquote__wrap-img"><?= picture('img/@lp/@version-kotler/whois/graph.gif', 'lazy') ?></div>
	</div><!-- blockquote__wrap -->

	<div class="container-fluid">

		<div class="row whois__content whois__content_bottom">
			<div class="whois__img whois__img_bottom"><?= picture('img/@lp/@version-kotler/whois/img_1.png', 'lazy') ?></div>
			<div class="whois__text whois__text_bottom">
				<p><?= _('whois__kotler_text_3') ?></p>
				<p><?= _('whois__kotler_text_4') ?></p>
			</div>
		</div>
...
<section class="opposition" id="opposition">

	<div class="container-fluid">

		<div class="row opposition__content">
			<div class="opposition__text">
				<div class="opposition__left">
					<div class="opposition__text--title">
						<h2 class="opposition__title xcondensed color-blue"><?= _('opposition__kotler_title') ?></h2>
					</div>
					<div class="opposition__text--box">
						<p><?= _('opposition__kotler_text_1') ?></p>
					</div>
				</div>
				<div class="opposition__img">
					<?= picture('img/@lp/@version-kotler/opposition/photo1.png', 'lazy') ?>
				</div>
			</div>
		</div>
	...
	<div class="opposition__box">
		<div class="opposition__box-text"><?= _('opposition__kotler_box_text1') ?></div>
		<div class="opposition__box-item opposition__box-item_1"><?= _('opposition__kotler_box_item1') ?></div>
		<div class="opposition__box-item opposition__box-item_2"><?= _('opposition__kotler_box_item2') ?></div>
		<div class="opposition__box-item opposition__box-item_3"><?= _('opposition__kotler_box_item3') ?></div>
		<div class="opposition__box-item opposition__box-item_4"><?= _('opposition__kotler_box_item4') ?></div>
		<div class="opposition__box-text"><?= _('opposition__kotler_box_text2') ?></div>
	</div>
			

	<div class="blockquote__wrap">
		<div class="blockquote__subtitle"><?= _('opposition__kotler_subtitlte_text') ?></div>
		<div class="blockquote__img blockquote__img--top--right"><?= picture('img/@lp/@version-kotler/opposition/gif9.gif', 'lazy') ?></div>
		<div class="blockquote">
			<div class="container">
				<div class="blockquote__text">
					<p><?= _('opposition__kotler_blockquote_text') ?></p>
				</div>
			</div>			
		</div>
	</div>
...
<section class="what-now" id="what-now">
	...
	<div class="what-now__box">
		<div class="row what-now__img"><?= picture('img/@lp/@version-kotler/what-now/big_img.jpg', 'lazy') ?></div>
	</div>

	<div class="what-now__box">
		<div class="what-now__top">
			<h2 class="what-now__title xcondensed color-blue"><?= _('what-now__kotler_title') ?></h2>
			<p class="what-now__subtitle xcondensed"><?= _('what-now__kotler_subtitle') ?></p>
		</div>
	</div>

	<div class="what-now__box">

		<div class="row what-now__content what-now__content_top">
			<div class="what-now__text what-now__text_top">
				<p><?= _('what-now__kotler_text_1') ?></p>
				<p><?= _('what-now__kotler_text_2') ?></p>
			</div>
			<div class="what-now__img-small"><?= picture('img/@lp/@version-kotler/what-now/30.png', 'lazy') ?></div>
		</div>
	...
	<div class="blockquote__wrap">
		<div class="blockquote">		
			<div class="container blockquote__container">
				<div class="blockquote__text">
					<p><?= _('what-now__kotler_blockquote_text1') ?></p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="what-now__box">
		...
		<div class="row what-now__content what-now__content_bottom">
			<div class="what-now__text what-now__text_bottom">
				<p><?= _('what-now__kotler_text_3') ?></p>
			</div>
			<div class="what-now__img-big"><?= picture('img/@lp/@version-kotler/what-now/kotler.png', 'lazy') ?></div>
		</div>

	</div>

</section><!-- breakthrough -->
<section class="became-few" id="became-few">

	<div class="became-few__box">		
		<h2 class="became-few__title xcondensed color-blue"><?= _('became-few__kotler_title') ?></h2>
	</div>
	<div class="blockquote__wrap">
		<div class="blockquote">		
			<div class="container blockquote__container">
				...
				<div class="blockquote__text">
					<p><?= _('became-few__kotler_blockquote_text1') ?></p>

					<div class="blockquote__text-box">
						<div class="blockquote__text-inner">
							<p><?= _('became-few__kotler_blockquote_text2') ?></p>
						</div>
						<div class="blockquote__text-img"><?= picture('img/@lp/@version-kotler/became-few/3.gif', 'lazy') ?></div>
					</div>

					<p><?= _('became-few__kotler_blockquote_text3') ?></p>
				</div>
...
<section class="charge" id="charge">

	<div class="container-fluid">

		<div class="row charge__content">
			<div class="charge__text">
				<div class="charge__left">
					<div class="charge__text--title">
						<h2 class="charge__title xcondensed color-blue"><?= _('charge__kotler_title') ?></h2>
					</div>
					<div class="charge__text--box">
						<p><?= _('charge__kotler_text_1') ?></p>
					</div>
				</div>
				<div class="charge__img">
					<?= picture('img/@lp/@version-kotler/charge/photo1.png', 'lazy') ?>
				</div>
			</div>
		</div>
	...
	<div class="blockquote__wrap blockquote__wrap_top">
		<div class="blockquote">
			<div class="container">
				<div class="blockquote__text">
					<p><?= _('charge__kotler_blockquote_text1') ?></p>
				</div>
			</div>			
		</div>
	</div>
	...
	<div class="charge__tabs tabs">		
		<div class="tabs__row">

			<div class="tabs__col">
				<p class="tabs__text"><?= _('charge__tabs_kotler_text') ?></p>
			</div>
			
			<div class="tabs__cont tabs-content" data-author="nike" id="tabs-content1">
			<div class="tabs__cont-top"><img src="img/@lp/@version-kotler/charge/logo_1.jpg" alt=""></div>
			<div class="tabs__cont-wrap">
				<div class="tabs__cont-text"><?= _('charge__tabs_kotler_cont_text1') ?></div>
				<div class="tabs__cont-photo"><img class="" src="img/@lp/@version-kotler/charge/tab_photo_1.png" alt="photo” жиро"></div>
			</div>
			</div>

			<div class="tabs__cont tabs-content active" data-author="harley-davidson" id="tabs-content2">
			<div class="tabs__cont-top"><img src="img/@lp/@version-kotler/charge/logo_2.jpg" alt=""></div>
			<div class="tabs__cont-wrap">
				<div class="tabs__cont-text"><?= _('charge__tabs_kotler_cont_text2') ?></div>
				<div class="tabs__cont-photo"><img class="" src="img/@lp/@version-kotler/charge/tab_photo_2.png" alt="photo” жиро"></div>
			</div>
			</div>

			<div class="tabs__cont tabs-content" data-author="lego" id="tabs-content3">
			<div class="tabs__cont-top"><img src="img/@lp/@version-kotler/charge/logo_3.jpg" alt=""></div>
			<div class="tabs__cont-wrap">
				<div class="tabs__cont-text"><?= _('charge__tabs_kotler_cont_text3') ?></div>
				<div class="tabs__cont-photo"><img class="" src="img/@lp/@version-kotler/charge/tab_photo_3.png" alt="photo” жиро"></div>
			</div>
			</div>

			<div class="tabs__cont tabs-content" data-author="starbucks" id="tabs-content4">
			<div class="tabs__cont-top"><img src="img/@lp/@version-kotler/charge/logo_4.jpg" alt=""></div>
			<div class="tabs__cont-wrap">
				<div class="tabs__cont-text"><?= _('charge__tabs_kotler_cont_text4') ?></div>
				<div class="tabs__cont-photo"><img class="" src="img/@lp/@version-kotler/charge/tab_photo_4.png" alt="photo” жиро"></div>
			</div>
			</div>
		</div>
	</div>

	<div class="blockquote__wrap blockquote__wrap_bottom">
		<div class="blockquote">
			<div class="container">
				<div class="blockquote__text">
					<p><?= _('charge__kotler_blockquote_text2') ?></p>
				</div>
			</div>			
		</div>
	</div>
...
<section class="soul" id="soul">
	...
	<div class="soul__box">
		<div class="row soul__img"><?= picture('img/@lp/@version-kotler/soul/big_img.jpg', 'lazy') ?></div>
	</div>

	<div class="soul__box">
		<div class="soul__top">
			<h2 class="soul__title xcondensed color-blue"><?= _('soul__kotler_title') ?></h2>
			<p class="soul__subtitle xcondensed"><?= _('soul__kotler_subtitle') ?></p>
			<div class="soul__img-gif"><?= picture('img/@lp/@version-kotler/soul/4.gif', 'lazy') ?></div>
		</div>
	</div>

	<div class="soul__box">

		<div class="row soul__content soul__content_top">
			<div class="soul__text soul__text_top">
				<p><?= _('soul__kotler_text_1') ?></p>
			</div>
			<div class="soul__img-big"><?= picture('img/@lp/@version-kotler/soul/30.jpg', 'lazy') ?></div>
		</div>
	...
	<div class="blockquote__wrap">
		<div class="blockquote">		
			<div class="container blockquote__container">
				<div class="blockquote__text">
					<p><?= _('soul__kotler_blockquote_text1') ?></p>
				</div>
			</div>
		</div>
	</div>
...
<section class="what-will" id="what-will">

	<div class="container-fluid">

		<div class="row what-will__content">
			<div class="what-will__text">
				<h2 class="what-will__title xcondensed color-blue"><?= _('what-will__kotler_title') ?></h2>
				<p class="what-will__subtitle xcondensed color-blue"><?= _('what-will__kotler_subtitle') ?></p>
				<p class="what-will__text-1"><?= _('what-will__kotler_text_1') ?></p>
			</div>
			<div class="what-will__img what-will__img_top"><?= picture('img/@lp/@version-kotler/what-will/kotler.png', 'lazy') ?></div>
		</div>
...
<section class="platform" id="platform">
    <div class="container platform-container">
        <h2 class="platform-title xcondensed color-blue fix"><?= _('platform__kotler__title') ?></h2>
        <?= picture('img/@lp/@version-kotler/platform/logo.svg', 'lazy platform-logo') ?>
        <p class="platform-text"><?= _('platform__kotler__text') ?></p>
        <div class="platform__block swiper-wrapper">
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-kotler/platform/pic-1.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__kotler__block_text_1') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-kotler/platform/pic-2.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__kotler__block_text_2') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-kotler/platform/pic-3.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__kotler__block_text_3') ?></p>
            </div>
...
<form class="form form_vertical" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=registration-speaker">

	
	<div class="form__title condensed"><?= $version_form_title ?></div>
...
<div class="form__item form__item_email " data-name="email">
		...
		<div class="form__item form__item_button">
			<button class="form__button button button_red condensed condensed" type="submit"><?= $version_form_button ?></button>
...
<form class="form form_vertical" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=popup-speakers-offer">
...
<div class="form__item form__item_input " data-name="comments[Тема выступления]">
		...
		<input name="comments[Тема выступления]" type="input" placeholder="<?= _("popup-speakers-offer__theme") ?>" value="" class="form__input"  required >
