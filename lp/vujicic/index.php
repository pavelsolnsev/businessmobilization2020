...
<form class="form form_inline" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=intro">

	
	<div class="form__title "><?= _('main__form-title') ?></div>
...
<div class="form__item form__item_email " data-name="email">
		...
		<div class="form__item form__item_button">
			<button class="form__button button color-red condensed" type="submit"><?= _('version_form_button_reg') ?></button>
...
<form class="form form_vertical" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=intro">

	
	<div class="form__title "><?= $version_form_title ?></div>
...
<section class="themes" id="themes">
	<div class="container">
		...
		<div class="themes__title-1 condensed color-blue"><?= _('themes__title-1-vujicic') ?></div>
		<div class="themes__title-2 condensed color-red"><?= _('themes__title-2-vujicic') ?></div>
		<div class="themes__title-3 condensed color-blue"><?= _('themes__title-3-vujicic') ?></div>
		<div class="themes__text"><?= _('themes__title-4-vujicic') ?></div>
		<div data-href="" class="themes__video">
			<div class="themes__video-image"><?= picture('img/@lp/@speaker/themes/video.jpg', 'lazy') ?></div>
			<!-- <div class="themes__video-text condensed"><i class="icon-play"></i>Смотреть видео <br>о&nbsp;Нике Вуйчиче</div> -->
		</div>
...
<section class="result" id="result">
	<div class="container">
		<div class="result__title title"><?= _('result__title-vujicic') ?></div>

		<div class="row">
			<div class="col-6 col-md-4 result__item-col">
				<div class="result__item"><?= _('result__item_1-vujicic') ?></div>
			</div><!-- col -->
			<div class="col-6 col-md-4 result__item-col">
				<div class="result__item"><?= _('result__item_2-vujicic') ?></div>
			</div><!-- col -->
			<div class="col-6 col-md-4 result__item-col">
				<div class="result__item"><?= _('result__item_3-vujicic') ?></div>
			</div><!-- col -->
			<div class="col-6 col-md-4 result__item-col">
				<div class="result__item"><?= _('result__item_4-vujicic') ?></div>
			</div><!-- col -->
			<div class="col-6 col-md-4 result__item-col">
				<div class="result__item"><?= _('result__item_5-vujicic') ?></div>
			</div><!-- col -->
			<div class="col-6 col-md-4 result__item-col">
				<div class="result__item"><?= _('result__item_6-vujicic') ?></div>
			</div><!-- col -->
		</div><!-- row -->

		<div class="result__form main__bottom-form">
			
<?php
global $action, $land, $version, $grtag, $version_form_title, $version_form_button, $blackFriday, $PRICE_SYNCHRO_CURRENT, $IS_PROMOCODE, $version_promocode, $quote_id, $version_popup_tickets_form;
?>

<form class="form form_inline" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=result">
...
<div class="form__item form__item_email " data-name="email">
		...
		<div class="form__item form__item_button">
			<button class="form__button button color-red condensed" type="submit"><?= $version_form_button ?></button>
...
<section class="about" id="about">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-xl-4 order-md-2">
				<div class="about__image">
					<?= picture('img/@lp/@speaker/about/photo.jpg', 'lazy') ?>
				</div>
			</div><!-- col -->
			<div class="col-md-8 col-xl-8">
				<div class="about__title title"><?= _('about__vujicic_title') ?></div>
				<div class="about__text"><?= _('about__vujicic_text') ?></div>
			</div><!-- col -->
		</div><!-- row -->
		...
		<div class="about__info">
			<div class="row">
				<div class="col-6 col-md-3">
					<div class="about__info-title color-red"><?= _('about__vujicic_info_1') ?></div>
					<div class="about__info-text"><?= _('about__vujicic_info_text_1') ?></div>
				</div><!-- col -->
				<div class="col-6 col-md-3">
					<div class="about__info-title color-red"><?= _('about__vujicic_info_2') ?></div>
					<div class="about__info-text"><?= _('about__vujicic_info_text_2') ?></div>
				</div><!-- col -->
				<div class="col-6 col-md-3">
					<div class="about__info-title color-red"><?= _('about__vujicic_info_3') ?></div>
					<div class="about__info-text"><?= _('about__vujicic_info_text_3') ?></div>
				</div><!-- col -->
				<div class="col-6 col-md-3">
					<div class="about__info-title color-red"><?= _('about__vujicic_info_4') ?></div>
					<div class="about__info-text"><?= _('about__vujicic_info_text_4') ?></div>
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- about__info -->
...
<section class="rules" id="rules">
	<div class="container">
		...
		<div class="rules__title title"><?= _('rules__title-vujicic') ?></div>

		<div class="rules__slider carousel serif">
			
			<div class="rules-card">
				<?= _("rules-card_1-vujicic") ?>
			</div><!-- rules__card -->
			
			<div class="rules-card">
				<?= _("rules-card_2-vujicic") ?>
			</div><!-- rules__card -->
			
			<div class="rules-card">
				<?= _("rules-card_3-vujicic") ?>
			</div><!-- rules__card -->
			
			<div class="rules-card">
				<?= _("rules-card_4-vujicic") ?>
			</div><!-- rules__card -->
			
			<div class="rules-card">
				<?= _("rules-card_5-vujicic") ?>
			</div><!-- rules__card -->
...
<section class="platform" id="platform">
	<div class="container">
		...
		<div class="platform__title title"><?= _('online-plf__title') ?></div>
		<div class="platform__logo"><?= picture('img/@lp/@speaker/platform/logo.svg', 'lazy') ?></div>
		<div class="platform__text">
			<div class="d-none d-md-block"><?= _('online-plf__text') ?></div>
			<div class="d-md-none"><?= _('online-plf__text_mob') ?></div>
		</div><!-- platform__text -->

		<div class="platform__features">
			<div class="row">
				<div class="col-6 col-md-4 platform__features-card-col">
					<div class="platform__features-card">
						<div class="platform__features-card-image"><?= picture('img/@lp/@speaker/platform/1.svg', 'lazy') ?></div>
						<div><?= _('about__text_1') ?></div>
					</div><!-- platform__features-card -->
				</div><!-- col -->
				<div class="col-6 col-md-4 platform__features-card-col">
					<div class="platform__features-card">
						<div class="platform__features-card-image"><?= picture('img/@lp/@speaker/platform/2.svg', 'lazy') ?></div>
						<div><?= _('about__text_2') ?></div>
					</div><!-- platform__features-card -->
				</div><!-- col -->
				<div class="col-6 col-md-4 platform__features-card-col">
					<div class="platform__features-card">
						<div class="platform__features-card-image"><?= picture('img/@lp/@speaker/platform/3.svg', 'lazy') ?></div>
						<div><?= _('about__text_3') ?></div>
					</div><!-- platform__features-card -->
				</div><!-- col -->
				<div class="col-6 col-md-4 platform__features-card-col">
					<div class="platform__features-card">
						<div class="platform__features-card-image"><?= picture('img/@lp/@speaker/platform/4.svg', 'lazy') ?></div>
						<div><?= _('about__text_4') ?></div>
					</div><!-- platform__features-card -->
				</div><!-- col -->
				<div class="col-6 col-md-4 platform__features-card-col">
					<div class="platform__features-card">
						<div class="platform__features-card-image"><?= picture('img/@lp/@speaker/platform/5.svg', 'lazy') ?></div>
						<div><?= _('about__text_5') ?></div>
					</div><!-- platform__features-card -->
				</div><!-- col -->
				<div class="col-6 col-md-4 platform__features-card-col">
					<div class="platform__features-card">
						<div class="platform__features-card-image"><?= picture('img/@lp/@speaker/platform/6.svg', 'lazy') ?></div>
						<div><?= _('about__text_6') ?></div>
					</div><!-- platform__features-card -->
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- platform__features -->

		<div class="platform__image"><?= picture('img/@lp/@speaker/platform/screen.jpg', 'lazy') ?></div>
...
<section class="base" id="base">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-7">
				<div class="base__logo"><?= picture('img/@lp/@speaker/base/logo.svg', 'lazy') ?></div>
				<div class="base__text"><?= _('base__text') ?></div>
			</div><!-- col -->
			<div class="col-md-5">
				<div class="base__image"><?= picture('img/@lp/@speaker/base/screen.jpg', 'lazy') ?></div>
			</div><!-- col -->
		</div><!-- row -->

		<div class="base__features">
			<div class="row">
				<div class="col-md-4 base__features-card-col">
					<div class="base__features-card"><?= _('base__col-item-1') ?></div>
				</div><!-- col -->
				<div class="col-md-4 base__features-card-col">
					<div class="base__features-card"><?= _('base__col-item-4') ?></div>
				</div><!-- col -->
				<div class="col-md-4 base__features-card-col">
					<div class="base__features-card"><?= _('base__col-item-3') ?></div>
				</div><!-- col -->
				<div class="col-md-4 base__features-card-col">
					<div class="base__features-card"><?= _('base__col-item-2') ?></div>
				</div><!-- col -->
				<div class="col-md-4 base__features-card-col">
					<div class="base__features-card"><?= _('base__col-item-5') ?></div>
				</div><!-- col -->
				<div class="col-md-4 base__features-card-col">
					<div class="base__features-card"><?= _('base__col-item-6') ?></div>
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- base__features -->
		...
		<div class="row services__row">
			...
			<div class="col-6 col-md-4 services-card__col">
				<div class="services-card">
						...
						<?= picture('img/services/sydi.svg', 'lazy') ?>
			...
			<div class="col-6 col-md-4 services-card__col">
				<div class="services-card">
						...
						<?= picture('img/services/synbot.svg', 'lazy') ?>
			...
			<div class="col-6 col-md-4 services-card__col">
				<div class="services-card">
						...
						<?= picture('img/services/scrm.svg', 'lazy') ?>
			...
			<div class="col-6 col-md-4 services-card__col">
				<div class="services-card">
						...
						<?= picture('img/services/sgtrade.svg', 'lazy') ?>
			...
			<div class="col-6 col-md-4 services-card__col">
				<div class="services-card">
						...
						<?= picture('img/services/spay.svg', 'lazy') ?>
			...
			<div class="col-6 col-md-4 services-card__col">
				<div class="services-card">
						...
						<?= picture('img/services/sdesign.svg', 'lazy') ?>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-xl-8">
					<div class="franchise__title condensed color-red"><?= _('franchise__title') ?></div>
				</div><!-- col -->
				<div class="col-lg-6 col-xl-4">
					<div class="franchise__subtitle-1"><?= _('franchise__subtitle-1') ?></div>
					<div class="franchise__subtitle-2"><?= _('franchise__subtitle-2') ?></div>
					<a href="#popup-franchise" data-fancybox class="franchise__button button button_red condensed"><?= _('franchise__button') ?></a>
				</div><!-- col -->
			</div><!-- row -->
			...
			<div class="row condensed d-none d-xl-flex">
				<div class="col-lg-4">
					<div class="franchise__item">
						<div class="franchise__item-image"><?= picture('img/franchise/1.png', 'lazy') ?></div>
						<?= _('franchise__item-1') ?>
					</div><!-- franchise__item -->
				</div><!-- col -->
				<div class="col-lg-4">
					<div class="franchise__item">
						<div class="franchise__item-image"><?= picture('img/franchise/2.png', 'lazy') ?></div>
						<?= _('franchise__item-2') ?>
					</div><!-- franchise__item -->
				</div><!-- col -->
				<div class="col-lg-4">
					<div class="franchise__item">
						<div class="franchise__item-image"><?= picture('img/franchise/3.png', 'lazy') ?></div>
						<?= _('franchise__item-3') ?>
					</div><!-- franchise__item -->
				</div><!-- col -->
			</div><!-- row -->
...
<div class="faq" id="faq">
	...
	<div class="container">
		...
		<div class="faq__box">
			...
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-1") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-1") ?></div>
			</div>
			
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-2") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-2") ?></div>
			</div>
			
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-3") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-3") ?></div>
			</div>
			
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-4") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-4") ?></div>
			</div>
			
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-5") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-5") ?></div>
			</div>
			
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-6") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-6") ?></div>
			</div>
			
			<div class="faq__item">
				<div class="faq__item-top"><?= _("faq-question-7") ?></div>
				<div class="faq__item-bottom"><?= _("faq-answer-7") ?></div>
			</div>
...
<form class="form form_inline" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=intro-2">
...
<form class="form form_vertical" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=intro-2">
