...
<section class="main main-1" id="main-1" data-fancybox href="#popup-registration">
...
<section class="about" id="about">
	...
	<div class="container">
		<div class="about__title xcondensed color-blue"><?= _('about__norris_title') ?></div>
		<div class="about__text"><?= _('about__norris_text') ?></div>
		<div class="about__img d-sm-none"><?= picture('img/@lp/@version-norris/about/gif1.gif', 'lazy') ?></div>
	</div><!-- container -->

	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('about__norris_blockquote_text_1') ?></p>
			</div>
		</div>
		<div class="blockquote__img blockquote__img--bottom--right"><?= picture('img/@lp/@version-norris/about/gif1.gif', 'lazy') ?></div>
	</div>
...
<section class="registration registration-1" id="registration-1">
	<div class="container">
...
<form class="form form_inline" action="<?= $action ?>&amp;land=<?= $land ?>&amp;grtag=<?= $grtag ?>&amp;quote_id=<?= $quote_id ?>&amp;form=registration-1">

	
	<div class="form__title xcondensed"><?= _("registration__taleb_title") ?></div>
...
<div class="form__item form__item_email " data-name="email">
		...
		<div class="form__item form__item_button">
			<button class="form__button button  condensed" type="submit"><?= _("registration__taleb_button") ?></button>
...
<section class="beginning">
    <div class="container-fluid">
        <div class="beginning__photo_mobile"><img src="img/@lp/@version-norris/beginning/begin-mobile.png" alt=""></div>
        
        <div class="beginning__top beginning__padding">
            <div class="beginning__left"><img src="img/@lp/@version-norris/beginning/begin-1.jpg" alt=""></div>
            <div class="beginning__right">
                <h2 class="beginning__title xcondensed color-blue"><?= _('beginning__norris__title') ?></h2>
                <p class="beginning__text beginning__text_width"><?= _('beginning__norris__text_1') ?></p>
                <p class="beginning__text"><?= _('beginning__norris__text_2') ?></p>
                <p class="beginning__text beginning__text_3"><?= _('beginning__norris__text_3') ?></p>
                <div class="beginning__img"><?= picture('img/@lp/@version-norris/beginning/gif2.gif', 'lazy') ?></div>
            </div>
        </div>
        ...
        <div class="blockquote">
            <div class="container">
                <div class="blockquote__text">
                    <p><?= _('beginning__norris__blockquote_description') ?></p>
                </div>
            </div>
        </div>
...
<section class="reputation" id="reputation">
	...
	<div class="container-fluid">
		...
		<div class="row reputation__content">
			<div class="reputation__text">
				<div class="reputation__img reputation__img_right"><?= picture('img/@lp/@version-norris/reputation/big_img.png', 'lazy') ?></div>
				<div class="reputation__text--title">
					<h2 class="reputation__title xcondensed color-blue"><?= _('reputation__norris_title') ?></h2>
				</div>
				<div class="reputation__text--box">
					<p><?= _('reputation__norris_text_box-1') ?></p>
					<p><?= _('reputation__norris_text_box-2') ?></p>
				</div>
			</div>
		</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('reputation__norris_blockquote_text_1') ?></p>
			</div>
		</div>
		<div class="blockquote__img blockquote__img--bottom--left"><?= picture('img/@lp/@version-norris/reputation/gif3.gif', 'lazy') ?></div>
	</div>

	<div class="container-fluid">

		<div class="row reputation__content reputation__content--bottom">
			<div class="reputation__img reputation__img_left d-none d-lg-block"><?= picture('img/@lp/@version-norris/reputation/img_left.png', 'lazy') ?></div>
			<div class="reputation__text reputation__text--bottom">
				<p><?= _('reputation__norris_content_text_1') ?></p>
			<div class="reputation__img reputation__img_left d-lg-none"><?= picture('img/@lp/@version-norris/reputation/img_left.png', 'lazy') ?></div>
				<p><?= _('reputation__norris_content_text_2') ?></p>
			</div>
		</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('reputation__norris_blockquote_text_2') ?></p>
			</div>
		</div>
	</div>
...
<section class="pay" id="pay">
	...
	<div class="container-fluid">
		<div class="row pay__img"><?= picture('img/@lp/@version-norris/pay/big_img.jpg', 'lazy') ?></div>
	</div>

	<div class="container container--top">
		<div class="pay__top">
			<h2 class="pay__title xcondensed color-blue"><?= _('pay__norris_title') ?></h2>
			<p class="pay__pretitle"><?= _('pay__norris_pretitle') ?></p>
			<p class="pay__subtitle xcondensed"><?= _('pay__norris_subtitle') ?></p>
		</div>
	</div>	

<div class="container-fluid">

	<div class="row pay__content pay__content--top">
		<div class="pay__text">
			<p><?= _('pay__norris_text_1') ?></p>
			<p><?= _('pay__norris_text_2') ?></p>
		</div>
		<div class="pay__img-gif"><?= picture('img/@lp/@version-norris/pay/photo1.png', 'lazy') ?></div>
	</div>
	...
	<div class="blockquote">		
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('pay__norris_blockquote_text1') ?></p>
			</div>
		</div>
		<div class="blockquote__img"><?= picture('img/@lp/@version-norris/pay/gif4.gif', 'lazy') ?></div>
	</div>


</section><!-- breakthrough -->
<section class="lee" id="lee">

	<div class="container-fluid">

		<div class="row lee__content">
			<div class="lee__text">
				<div class="lee__left">
					<div class="lee__text--title">
						<h2 class="lee__title xcondensed color-blue"><?= _('lee__norris_title') ?></h2>
					</div>
					<div class="lee__text--box">
						<p><?= _('lee__norris_text_1') ?></p>
						<p><?= _('lee__norris_text_2') ?></p>
					</div>
				</div>
				<div class="lee__img lee__img_right" id="lee__img_right">
					<div class="lee__img-box">
						<div class="lee__img-inner"><?= picture('img/@lp/@version-norris/lee/photo1.jpg', 'lazy') ?></div>
						<div class="lee__img-signature"><?= _('lee__norris_signature') ?></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="blockquote blockquote_top">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('lee__norris_blockquote_text_1') ?></p>
			</div>
		</div>
		<div class="blockquote__img blockquote__img--bottom--1"><?= picture('img/@lp/@version-norris/lee/gif5.gif', 'lazy') ?></div>
	</div>

	<div class="container-fluid">

		<div class="row lee__content">
			<div class="lee__text lee__text_bottom">

				<div class="lee__img lee__img_left">
					<div class="lee__img-inner"><?= picture('img/@lp/@version-norris/lee/photo2.jpg', 'lazy') ?></div>
				</div>

				<div class="lee__right">
					<div class="lee__text--box">
						<p><?= _('lee__norris_text_3') ?></p>
						<p><?= _('lee__norris_text_4') ?></p>
					</div>
				</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('lee__norris_blockquote_text_2') ?></p>
			</div>
		</div>
		<div class="blockquote__img blockquote__img--bottom--2"><?= picture('img/@lp/@version-norris/lee/gif6.gif', 'lazy') ?></div>
	</div>
...
<section class="start" id="start">
	...
	<div class="container-fluid">
		...
		<div class="row start__content">
			<div class="start__text">
				<div class="start__img start__img_left">
					<div class="start__img-box">
						<div class="start__img-inner"><?= picture('img/@lp/@version-norris/start/photo1.jpg', 'lazy') ?></div>
						<div class="start__img-signature"><?= _('start__norris_signature') ?></div>
					</div>
				</div>
				<div class="start__right">
					<div class="start__text--title">
						<h2 class="start__title xcondensed color-blue"><?= _('start__norris_title') ?></h2>
					</div>
					<div class="start__text--box">
						<p><?= _('start__norris_text_1') ?></p>
						<p><?= _('start__norris_text_2') ?></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('start__norris_blockquote_text_1') ?></p>
			</div>
		</div>
	</div>
		...
		<div class="row start__content">
			<div class="start__text">
				<div class="start__left">
					<div class="start__text--box">
						<p><?= _('start__norris_text_3') ?></p>
						<p><?= _('start__norris_text_4') ?></p>
					</div>
				</div>

				<div class="start__img start__img_right">
					<div class="start__img-inner"><?= picture('img/@lp/@version-norris/start/photo2.jpg', 'lazy') ?></div>
				</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('start__norris_blockquote_text_2') ?></p>
			</div>
		</div>
		<div class="blockquote__img blockquote__img--bottom--right"><?= picture('img/@lp/@version-norris/start/gif7.gif', 'lazy') ?></div>
	</div>


</section><!-- comingsoon -->

<section class="what-now" id="what-now">

	<div class="container-fluid">
		<div class="row what-now__img"><?= picture('img/@lp/@version-norris/what-now/big_img.jpg', 'lazy') ?></div>
	</div>

	<div class="container">
		<div class="what-now__top">
			<h2 class="what-now__title xcondensed color-blue"><?= _('what-now__norris_title') ?></h2>
			<p class="what-now__pretitle"><?= _('what-now__norris_pretitle') ?></p>
			<p class="what-now__subtitle xcondensed"><?= _('what-now__norris_subtitle') ?></p>
			<div class="what-now__gif"><?= picture('img/@lp/@version-norris/what-now/gif8.gif', 'lazy') ?></div>
		</div>
	</div>	
	...
	<div class="container-fluid">
		...
		<div class="row what-now__content">
			<div class="what-now__text what-now__text_left">
				<p><?= _('what-now__norris_text_1') ?></p>
				<p><?= _('what-now__norris_text_2') ?></p>
				<p><?= _('what-now__norris_text_3') ?></p>
			</div>
			<div class="what-now__img-small what-now__img-small_1"><?= picture('img/@lp/@version-norris/what-now/photo1.jpg', 'lazy') ?></div>
		</div>
	...
	<div class="container-fluid">
		...
		<div class="row what-now__content what-now__content_bottom">
			<div class="what-now__img-small what-now__img-small_2"><?= picture('img/@lp/@version-norris/what-now/photo2.jpg', 'lazy') ?></div>
			<div class="what-now__text what-now__text_right">
				<p><?= _('what-now__norris_text_4') ?></p>
				<p><?= _('what-now__norris_text_5') ?></p>
			</div>
		</div>
...
<section class="comingsoon" id="comingsoon">
	...
	<div class="container-fluid">
		...
		<div class="row comingsoon__content">
			<div class="comingsoon__text">
				<div class="comingsoon__left">
					<div class="comingsoon__text--title">
						<h2 class="comingsoon__title xcondensed color-blue"><?= _('comingsoon__norris_title') ?></h2>

					</div>
					<div class="comingsoon__text--box">
						<p><?= _('comingsoon__norris_text_1') ?></p>
					</div>
				</div>
				<div class="comingsoon__img">
					<div class="comingsoon__img-inner"><?= picture('img/@lp/@version-norris/comingsoon/photo1.jpg', 'lazy') ?></div>
				</div>
			</div>
		</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('comingsoon__norris_blockquote_text') ?></p>
			</div>
		</div>
		<div class="blockquote__img blockquote__img--bottom--right"><?= picture('img/@lp/@version-norris/comingsoon/gif9.gif', 'lazy') ?></div>
	</div>

	<div class="container-fluid">
		<div class="row comingsoon__content">
			<div class="comingsoon__subtitle xcondensed color-blue"><?= _('comingsoon__norris_subtitle') ?></div>
		</div>
	</div>
...
<section class="platform" id="platform">
    <div class="container platform-container">
        <h2 class="platform-title xcondensed color-blue"><?= _('platform__besson__title') ?></h2>
        <?= picture('img/@lp/@version-besson/platform/logo.svg', 'lazy platform-logo') ?>
        <p class="platform-text"><?= _('platform__besson__text') ?></p>
        <div class="platform__block swiper-wrapper">
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-besson/platform/pic-1.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__besson__block_text_1') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-besson/platform/pic-2.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__besson__block_text_2') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-besson/platform/pic-3.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__besson__block_text_3') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-besson/platform/pic-4.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__besson__block_text_4') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-besson/platform/pic-5.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__besson__block_text_5') ?></p>
            </div>
            <div class="swiper-slide platform__block-item">
                <?= picture('img/@lp/@version-besson/platform/pic-6.svg', 'lazy platform__block-logo') ?>
                <p class="platform__block-text"><?= _('platform__besson__block_text_6') ?></p>
            </div>
        </div>
...
<section class="main main-2" id="main-2" data-fancybox href="#popup-registration">
...
<section class="footer" id="footer">
  <div class="container">
    <div class="row footer__row">
      ...
      <?php if ($lang == 'en') : ?>
        <div class="footer__col footer__col--3"><a href="files/privacy_en.pdf" class="footer__link-privacy" data-fancybox><?= _('footer__link-privacy-taleb') ?></a></div>
      <?php else: ?>
...
<div class="popup popup-message" id="popup-message-failed">
    <div class="popup-wrapper">
		...
		<div class="popup popup-other" id="popup-northrop">
	<div class="popup-other__inner">
		<div class="popup-other__img"><img data-src="img/@lp/@version-norris/popup/northrop.jpg" alt="" class="lazy"></div>
		<div class="popup-other__text"><?= _('popup-pay__text') ?></div>
	</div>
</div>

<div class="popup popup-other" id="popup-lee">
	<div class="popup-other__inner">
		<div class="popup-other__img"><img data-src="img/@lp/@version-norris/popup/lee.jpg" alt="" class="lazy"></div>
		<div class="popup-other__text"><?= _('lee__norris_signature') ?></div>
	</div>
</div>

<div class="popup popup-other" id="popup-mcqueen">
	<div class="popup-other__inner">
		<div class="popup-other__img"><img data-src="img/@lp/@version-norris/popup/mcqueen.jpg" alt="" class="lazy"></div>
		<div class="popup-other__text"><?= _('start__norris_signature') ?></div>
	</div>
</div>
