...
<section class="price" id="price">
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-demo" js-payment data-productId="<?= $PRODUCT_ID_DEMO ?>" data-is-recurrent="<?= $PRICE_DEMO_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="demo" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_DEMO_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_DEMO ?> <span class="currency">₽</span></div>
		...
		<?= $version_price_demo_option ?>
			...
			<div class="price-card__cost" data-price="<?= $PRICE_DEMO ?>"><?= $PRICE_DEMO ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_DEMO_IS_RECURRENT ?>">
...
<section class="price" id="price">
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-offline" js-payment data-productId="<?= $product_id_offline ?>" data-is-recurrent="<?= $offline_isRecurring ?>" data-quote_id="<?= $offline_quote_id ?>" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="offline" data-unit="<?= $offline_unit ?>" data-type="<?= $offline_type ?>" data-land="<?= $offline_land ?>" data-event-id="<?= $offline_event_id ?>" data-form-type="<?= $offline_form_type ?>">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $product_offline_name ?></div>			
			<div class="price-card__header-price"><?= $offline_price ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<?= $version_price_offline_option ?>
			...
			<div class="price-card__cost" data-price="<?= $offline_price ?>"><?= $offline_price ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card-offline__button") ?></div>

					
			<div class="price-card__label d-none <?= $offline_isRecurring ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-offline_standard" js-payment data-productId="<?= $product_id_offline_standard ?>" data-is-recurrent="<?= $offline_standard_isRecurring ?>" data-quote_id="<?= $offline_quote_id ?>" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="offline_standard" data-unit="" data-type="" data-land="<?= $offline_land ?>" data-event-id="<?= $offline_event_id ?>" data-form-type="<?= $offline_form_type ?>">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $product_offline_standard_name ?></div>			
			<div class="price-card__header-price"><?= $offline_standard_price ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<?= $version_price_offline_standard_option ?>
			...
			<div class="price-card__cost" data-price="<?= $offline_standard_price ?>"><?= $offline_standard_price ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card-offline__button") ?></div>

					
			<div class="price-card__label d-none <?= $offline_standard_isRecurring ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-offline_business" js-payment data-productId="<?= $product_id_offline_business ?>" data-is-recurrent="<?= $offline_business_isRecurring ?>" data-quote_id="<?= $offline_quote_id ?>" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="offline_business" data-unit="" data-type="" data-land="<?= $offline_land ?>" data-event-id="<?= $offline_event_id ?>" data-form-type="<?= $offline_form_type ?>">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $product_offline_business_name ?></div>			
			<div class="price-card__header-price"><?= $offline_business_price ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<?= $version_price_offline_business_option ?>
			...
			<div class="price-card__cost" data-price="<?= $offline_business_price ?>"><?= $offline_business_price ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card-offline__button") ?></div>

					
			<div class="price-card__label d-none <?= $offline_business_isRecurring ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-offline_vip" js-payment data-productId="<?= $product_id_offline_vip ?>" data-is-recurrent="<?= $offline_vip_isRecurring ?>" data-quote_id="<?= $offline_quote_id ?>" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="offline_vip" data-unit="" data-type="" data-land="<?= $offline_land ?>" data-event-id="<?= $offline_event_id ?>" data-form-type="<?= $offline_form_type ?>">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $product_offline_vip_name ?></div>			
			<div class="price-card__header-price"><?= $offline_vip_price ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<?= $version_price_offline_vip_option ?>
			...
			<div class="price-card__cost" data-price="<?= $offline_vip_price ?>"><?= $offline_vip_price ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card-offline__button") ?></div>

					
			<div class="price-card__label d-none <?= $offline_vip_isRecurring ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-month" js-payment data-productId="<?= $PRODUCT_ID_MONTH ?>" data-is-recurrent="<?= $PRICE_MONTH_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="month" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_MONTH_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_MONTH ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
			

			<div class="price-card__cost" data-price="<?= $PRICE_MONTH ?>"><?= $PRICE_MONTH ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_MONTH_IS_RECURRENT ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-6-month" js-payment data-productId="<?= $PRODUCT_ID_6_MONTH ?>" data-is-recurrent="<?= $PRICE_6_MONTH_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="6-month" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_6_MONTH_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_6_MONTH ?> <span class="currency">₽</span></div>
			<span class="price-card__discount">-30%</span>
		</div>
		<div class="price-card__body">
			

			<div class="price-card__cost" data-price="<?= $PRICE_6_MONTH ?>"><?= $PRICE_6_MONTH ?> <span class="currency">₽</span></div>
			
				<div class="price-card__cost-desc old">9 000 <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_6_MONTH_IS_RECURRENT ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-12-month" js-payment data-productId="<?= $PRODUCT_ID_12_MONTH ?>" data-is-recurrent="<?= $PRICE_12_MONTH_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="12-month" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_12_MONTH_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_12_MONTH ?> <span class="currency">₽</span></div>
			<span class="price-card__discount">-50%</span>
		</div>
		<div class="price-card__body">
			

			<div class="price-card__cost" data-price="<?= $PRICE_12_MONTH ?>"><?= $PRICE_12_MONTH ?> <span class="currency">₽</span></div>
			
				<div class="price-card__cost-desc old">18 000 <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_12_MONTH_IS_RECURRENT ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-subs-silver" js-payment data-productId="<?= $PRODUCT_ID_SUBS_SILVER ?>" data-is-recurrent="<?= $PRICE_SUBS_SILVER_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="subs-silver" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_SUBS_SILVER_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_SUBS_SILVER ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<div class="price-card__item">
			...
			<div class="price-card__cost" data-price="<?= $PRICE_SUBS_SILVER ?>"><?= $PRICE_SUBS_SILVER ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_SUBS_SILVER_IS_RECURRENT ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-subs-gold" js-payment data-productId="<?= $PRODUCT_ID_SUBS_GOLD ?>" data-is-recurrent="<?= $PRICE_SUBS_GOLD_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="subs-gold" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_SUBS_GOLD_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_SUBS_GOLD ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<div class="price-card__item">
			...
			<div class="price-card__cost" data-price="<?= $PRICE_SUBS_GOLD ?>"><?= $PRICE_SUBS_GOLD ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_SUBS_GOLD_IS_RECURRENT ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
	...
	<div href="#popup-price" data-fancybox class="price-card price-card_" id="price-subs-platinum" js-payment data-productId="<?= $PRODUCT_ID_SUBS_PLATINUM ?>" data-is-recurrent="<?= $PRICE_SUBS_PLATINUM_IS_RECURRENT ?>" data-quote_id="" data-partner="<?= $partner_external ? $partner_external : $partner ?>" data-package="subs-platinum" data-unit="" data-type="" data-land="" data-event-id="" data-form-type="">
		<div class="price-card__header">
			<div class="price-card__header-name"><?= $PRICE_SUBS_PLATINUM_NAME ?></div>			
			<div class="price-card__header-price"><?= $PRICE_SUBS_PLATINUM ?> <span class="currency">₽</span></div>
			<span class="price-card__discount"></span>
		</div>
		<div class="price-card__body">
		...
		<div class="price-card__item">
			...
			<div class="price-card__cost" data-price="<?= $PRICE_SUBS_PLATINUM ?>"><?= $PRICE_SUBS_PLATINUM ?> <span class="currency">₽</span></div>
			
			<div class="price-card__button button button_red"><?= _("new-price-card__button") ?></div>

					
			<div class="price-card__label d-none <?= $PRICE_SUBS_PLATINUM_IS_RECURRENT ?>">
				<div class="price-card__label-checkbox">
					<input type="checkbox" name="isRecurrent" checked>
					<div class="price-card__label-checkbox-icon lazy"></div>
				</div><!-- price-card__label-checkbox -->
...
<section class="price" id="price">
    ...
    <div class="payments__wrapper wrap_class">
    ...
    <div class="payments__wrapper legalforum_online">
    ...
    <div class="payments__wrapper wrap_class legalforum_offline">
...
<?php } ?>
	...
	<div class="popup-price__wrapper">
		...
		<div class="popup-price__form">
			<form class="form" action="<?= $action ?>&amp;form=<?= $version_price_form ?><?= $link_price ? '&link=' . urlencode($link_price) : '' ?>">
				<div class="form__wrapper">
					<div class="form__title"><?= _('popup-price-form__title') ?></div>
					<div class="form__input">
						<input type="text" class="input" name="name" placeholder="<?= _('form_item_name') ?>" tabindex="1" value="<?= $get_name ?>">
