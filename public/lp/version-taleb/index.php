...
<section class="main main-1 scroll" id="main-1" href="#price">
<?php else: ?>
...
<section class="about" id="about">
	...
	<div class="container">
		<div class="about__title xcondensed color-blue"><?= _('about__taleb_title') ?></div>
		<div class="about__text"><?= _('about__taleb_text') ?></div>
	</div><!-- container -->
...
<section class="whois" id="whois">
	...
	<div class="container-fluid">
		...
		<div class="row whois__content">
			<div class="whois__img"><?= picture('img/@lp/@version-taleb/whois/taleb.png', 'lazy') ?></div>
			<div class="whois__text">
				<h2 class="whois__title xcondensed color-blue"><?= _('whois__taleb_title') ?></h2>
				<p><?= _('whois__taleb_text_1') ?></p>
				<p><?= _('whois__taleb_text_2') ?></p>
				<p><?= _('whois__taleb_text_3') ?></p>
				<div class="whois__img--intext"><?= picture('img/@lp/@version-taleb/whois/graph.gif', 'lazy') ?></div>
			</div>
		</div>
	...
	<div class="blockquote">
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('whois__taleb_blockquote_text_1') ?></p>
				<p><?= _('whois__taleb_blockquote_text_2') ?></p>
			</div>
		</div>
	</div>
...
<section class="reputation" id="reputation">
	...
	<div class="container-fluid">
		...
		<div class="row reputation__content">
			<div class="reputation__text">
				<div class="reputation__img"><?= picture('img/@lp/@version-taleb/reputation/big_img.png', 'lazy') ?></div>
				<div class="reputation__text--title">
					<h2 class="reputation__title xcondensed color-blue"><?= _('reputation__taleb_title') ?></h2>
				</div>
				<div class="reputation__text--box">
					<p><?= _('reputation__taleb_text_box-1') ?></p>
					<p><?= _('reputation__taleb_text_box-2') ?></p>
				</div>
			</div>
		</div>
	...
	<div class="blockquote">
		<div class="blockquote__img blockquote__img--bottom--left"><?= picture('img/@lp/@version-taleb/reputation/img_left.png', 'lazy') ?></div>
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('reputation__taleb_blockquote_text_1') ?></p>
				<p><?= _('reputation__taleb_blockquote_text_2') ?></p>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row reputation__content reputation__content--bottom">
			<div class="reputation__text reputation__text--bottom">
				<p><?= _('reputation__taleb_content_text') ?></p>
			</div>
		</div>
...
<section class="pay" id="pay">
	...
	<div class="container-fluid">
		<div class="row pay__img"><?= picture('img/@lp/@version-taleb/pay/big_img.jpg', 'lazy') ?></div>
	</div>

	<div class="container container--top">
		<div class="pay__top">
			<h2 class="pay__title xcondensed color-blue"><?= _('pay__taleb_title') ?></h2>
			<p class="pay__subtitle xcondensed"><?= _('pay__taleb_subtitle') ?></p>
		</div>
	</div>	
...
<div class="container-fluid">
	...
	<div class="row pay__content pay__content--top">
		<div class="pay__text pay__text--middle">
			<?= _('pay__taleb_text_1') ?>
		</div>
		<div class="pay__img-gif"><?= picture('img/@lp/@version-taleb/pay/giphy_10.gif', 'lazy') ?></div>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row pay__content">
			<div class="pay__img-small"><?= picture('img/@lp/@version-taleb/pay/taleb.png', 'lazy') ?></div>
			<div class="pay__text pay__text--bottom">
				<p><?= _('pay__taleb_text_2') ?></p>
			</div>
		</div>
...
<section class="beginning">
    <div class="container-fluid">
        <div class="beginning__photo_mobile"><img src="img/@lp/@version-taleb/beginning/begin-mobile.png" alt=""></div>
        <h2 class="beginning__title xcondensed color-blue beginning__padding"><?= _('beginning__taleb__title') ?></h2>
        <div class="beginning__top beginning__padding">
            <div class="beginning__left">
                <p class="beginning__text beginning__text_width"><?= _('beginning__taleb__text_1') ?></p>
                <p class="beginning__text"><?= _('beginning__taleb__text_2') ?></p>
                <p class="beginning__text"><?= _('beginning__taleb__text_3') ?></p>
            </div>
            <div class="beginning__right"><img src="img/@lp/@version-taleb/beginning/begin-1.png" alt=""></div>
        </div>

        <div class="beginning__mid beginning__padding">
            <div class="blockquote">
                <div class="container">
                    <div class="blockquote__text">
                        <div class="blockquote__description"><?= _('beginning__taleb__blockquote_description') ?></div>
                        <p><?= _('beginning__taleb__blockquote_text') ?></p>
                    </div>
                </div>
            </div>
        </div>

        <div class="beginning__bottom tabs beginning__padding">
            <div class="tabs__row">
                <div class="tabs__col-1">
                    <div class="tabs__cont tabs-content active" data-author="jan-pol-sartr" id="tabs-content1">
                    <div class="tabs__cont-wrap">
                        <!-- <img class="tabs__img" src="img/@lp/@version-taleb/beginning/jan-sartra.png" alt=""> -->
                        <div class="tabs__author">
                            <img class="tabs__photo" src="img/@lp/@version-taleb/beginning/sartra.png" alt="">
                            <span class="tabs__name"><?= _('tabs__taleb_descr_1') ?></span>
                        </div>
                    </div>
                    </div>

                    <div class="tabs__cont tabs-content" data-author="civil-war" id="tabs-content2">
                    <div class="tabs__cont-wrap">
                        <!-- <img class="tabs__img" src="img/@lp/@version-taleb/beginning/jan-sartra.png" alt="Работы Жан-Клода мезьера"> -->
                        <div class="tabs__author tab-btn">
                            <img class="tabs__photo" src="img/@lp/@version-taleb/beginning/war.png" alt="">
                            <span class="tabs__name"><?= _('tabs__taleb_descr_2') ?></span>
                        </div>
                    </div>
                    </div>
                ...
                <div class="tabs__col-2">
                    <p class="tabs__text"><?= _('tabs__taleb_text') ?></p>
                </div>
                </div>
        </div>
...
<section class="after" id="after">
	...
	<div class="container-fluid">
		<div class="after__content">
			<h2 class="after__title xcondensed color-blue"><?= _('after__taleb__title') ?></h2>
			<div class="row after__content-inner">
				<div class="after__img">
					<div class="after__img-1"><?= picture('img/@lp/@version-taleb/after/giphy1.gif', 'lazy') ?></div>
					<div class="after__img-2"><?= picture('img/@lp/@version-taleb/after/giphy2.gif', 'lazy') ?></div>
					<div class="after__img-3"><?= picture('img/@lp/@version-taleb/after/giphy3.gif', 'lazy') ?></div>
				</div>
				<div class="after__text">
					<div><?= _('after__taleb__text') ?></div>
				</div>
			</div>
		</div>
	</div>
	...
	<?php /* ?>
	<div class="blockquote">
		<div class="blockquote__img blockquote__img--bottom--right"><?= picture('img/@lp/@version-taleb/after/img_3_right.png', 'lazy') ?></div>
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('after__taleb_blockquote_text') ?></p>
			</div>
		</div>
	</div>
	<?php */ ?>
...
<section class="what-now" id="what-now">
	...
	<div class="container-fluid">
		<div class="row what-now__img"><?= picture('img/@lp/@version-taleb/what-now/big_img.jpg', 'lazy') ?></div>
	</div>

	<div class="container">
		<div class="what-now__top">
			<h2 class="what-now__title xcondensed color-blue"><?= _('what-now__taleb_title') ?></h2>
			<p class="what-now__subtitle xcondensed"><?= _('what-now__taleb_subtitle') ?></p>
		</div>
	</div>	
	...
	<div class="blockquote">		
		<div class="container">
			<div class="blockquote__text">
				<p><?= _('what-now__taleb_blockquote_text1') ?></p>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid">
		...
		<div class="row what-now__content">
			<div class="what-now__text">
				<p><?= _('what-now__taleb_text_1') ?></p>
			</div>
			<div class="what-now__img-small"><?= picture('img/@lp/@version-taleb/what-now/taleb.png', 'lazy') ?></div>
		</div>

	</div>

	<div class="blockquote">
		<div class="blockquote__img blockquote__img--bottom--right"><?= picture('img/@lp/@version-taleb/what-now/30.png', 'lazy') ?></div>		
		<div class="container">
			<div class="blockquote__text blockquote__text--1">
				<p><?= _('what-now__taleb_blockquote_text2') ?></p>
			</div>
		</div>
	</div>
...
<section class="comingsoon" id="comingsoon">
	...
	<div class="container-fluid">
		...
		<div class="row comingsoon__content">
			<div class="comingsoon__img"><?= picture('img/@lp/@version-taleb/comingsoon/taleb.png', 'lazy') ?></div>
			<div class="comingsoon__text">
				<h2 class="comingsoon__title xcondensed color-blue"><?= _('comingsoon__taleb_title') ?></h2>
				<div class="comingsoon__subtitle xcondensed color-blue"><?= _('comingsoon__taleb_subtitle') ?></div>
				<p><?= _('comingsoon__taleb_text_1') ?></p>
				<p><?= _('comingsoon__taleb_text_2') ?></p>
				<p><?= _('comingsoon__taleb_text_3') ?></p>
			</div>
		</div>
