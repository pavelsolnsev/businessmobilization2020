$(function () {
	...
	function initTabs() {
		...
		// $(document).on('click', tabBtn, function(event) {
		// 	index++;

		// 	tabsContent.removeClass('active');
		// 	$('.tabs-content.current').next().addClass('active current');
		// 	$('.tabs-content.current').prev().removeClass('current');

		// 	if (index === tabsContent.length) {
		// 		index = 0;

		// 		$('.tabs-content').removeClass('current');
		// 		$('.tabs-content').first().addClass('active current');
		// 	}
		// })
